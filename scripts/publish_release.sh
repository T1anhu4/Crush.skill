...
OPENCLAW_ZIP="$SKILL_DIR/dist/crush_xiehou_openclaw.zip"
QWENPAW_ZIP="$SKILL_DIR/dist/crush_xiehou_qwenpaw.zip"
...
if [[ -n "$NOTES_FILE" ]]; then
  ...
  BODY="Crush.skill release $TAG\n\nAssets:\n- crush_xiehou_openclaw.zip\n- crush_xiehou_qwenpaw.zip"
fi
